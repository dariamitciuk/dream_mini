...
def handler(requested_data, random_seed=None):
    ...
    responses = []
    prompts = ["what do you think about ", "do you have any thoughts on ",
               "have you ever thought about ", "what's your opinion on ",
               "do you want to talk about ", "what do you think about the picture of ",
               "what are your thoughts on the photo of ", "do you like the picture of ",
               "how do you like the photo of "]
    for ctx in ctxs:
        try:
            # for tests
            if random_seed:
            ...
            ctx = actor(ctx)
            ctx = random.choice(prompts) + str(ctx)
